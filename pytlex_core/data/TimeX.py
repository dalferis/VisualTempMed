...
class TimeX:
    ...
    def to_json(self):
        ...
        return f'{{"id":"{self.get_id_str()}", "value":"{self.value}", "temporalFunction":"{self.temporalFunction}",' \
               f' "phrase":"{self.phrase}", "type":"{t_type}", "mod":"{mod}", "documentFunction":"' \
               f'{document_function}", "anchorID":"{anchor_id}", "quantity":"{quant}", "freq":"{freq}", "beginPoint":"' \
